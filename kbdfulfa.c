...
#define KBDBASE      0
#define KBDSHIFT_IDX 1
#define KBDCTRL_IDX  2
#define KBDALT_IDX   3
#define KBDALTGR_IDX 4
#define KBDALTGR_SHIFT_IDX 5
...
static MODIFIERS CharModifiers = {
    ...
    7,
    { 0 } /* Expanded by compiler in memory */
};

/* Fulfulde AZERTY character table */
/* Columns: Normal | Shift | Ctrl | AltGr | AltGr+Shift */
static VK_TO_WCHARS5 aVkToWch5[] = {
    /* Direct letters + AltGr Fulfulde characters */
    ...
    { 'Q',       CAPLOK, { 0x01B4, 0x01B3, 0x11,     'q',    'Q' } },    /* Direct: ƴ / Ƴ, AltGr: q / Q */
    ...
    /* Number row (AZERTY: numbers in Shift, symbols in Normal) */
    { '1',       0,      { '&',    '1',    WCH_NONE, WCH_NONE, WCH_NONE } },
    { '2',       0,      { 0x00E9, '2',    WCH_NONE, '~',      WCH_NONE } },
    { '3',       0,      { '"',    '3',    WCH_NONE, '#',      WCH_NONE } },
    { '4',       0,      { '\'',   '4',    WCH_NONE, '{',      WCH_NONE } },
    { '5',       0,      { '(',    '5',    WCH_NONE, '[',      WCH_NONE } },
    { '6',       0,      { '-',    '6',    WCH_NONE, '|',      WCH_NONE } },
    { '7',       0,      { 0x00E8, '7',    WCH_NONE, '`',      WCH_NONE } },
    { '8',       0,      { '_',    '8',    WCH_NONE, '\\',     WCH_NONE } },
    { '9',       0,      { 0x00E7, '9',    WCH_NONE, '^',      WCH_NONE } },
    { '0',       0,      { 0x00E0, '0',    WCH_NONE, '@',      WCH_NONE } },

    /* Punctuations & Special Keys */
    { VK_OEM_1,  0,      { '$',    0x00A3, WCH_NONE, 0x00A4, WCH_NONE } },
    { VK_OEM_2,  0,      { ':',    '/',    WCH_NONE, WCH_NONE, WCH_NONE } },
    { VK_OEM_3,  0,      { 0x00F9, '%',    WCH_NONE, WCH_NONE, WCH_NONE } },
    { VK_OEM_4,  0,      { ')',    0x00B0, WCH_NONE, ']',      WCH_NONE } },
    { VK_OEM_5,  0,      { '*',    0x00B5, WCH_NONE, WCH_NONE, WCH_NONE } },
    { VK_OEM_6,  0,      { '^',    0x00A8, WCH_NONE, WCH_NONE, WCH_NONE } },
    { VK_OEM_7,  0,      { 0x2019, 0x00B2, WCH_NONE, 0x2019, WCH_NONE } }, /* ² -> ’ hamza */
    { VK_OEM_8,  0,      { '!',    0x00A7, WCH_NONE, WCH_NONE, WCH_NONE } },
    { VK_OEM_COMMA, 0,   { ',',    '?',    WCH_NONE, WCH_NONE, WCH_NONE } },
    { VK_OEM_PERIOD, 0,  { ';',    '.',    WCH_NONE, WCH_NONE, WCH_NONE } },
    { VK_OEM_PLUS, 0,    { '=',    '+',    WCH_NONE, '}',      WCH_NONE } },
    { VK_OEM_MINUS, 0,   { ')',    0x00B0, WCH_NONE, ']',      WCH_NONE } },
...
/* ScanCode to Virtual Key mapping for French AZERTY */
static USHORT ausVSCtoVK[] = {
    VK_OEM_7,     /* 0x00 - Key ² (hamza) */
    VK_ESCAPE,    /* 0x01 */
    '1',          /* 0x02 */
    '2',          /* 0x03 */
    '3',          /* 0x04 */
...
__declspec(dllexport) PKBDTABLES KbdLayerDescriptor(VOID) {
    /* Initialize ModNumber in CharModifiers struct */
